...
<Note>
The `op-rbuilder` and `rollup-boost` implementations described here are maintained and distributed
externally; their source and images are not published from the Optimism monorepo.
</Note>
