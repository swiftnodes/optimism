...
integrations; `reth-optimism-flashblocks`; op-alloy flashblock wire types; `op-service` consumers;
and operator documentation pointing at supported external rollup-boost.
